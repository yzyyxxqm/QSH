...
from layers.tsl.utils import download_url, ensure_list
...
class EngRad(DatetimeDataset):
    r"""Weather measurements collected hourly in 487 cities spread across
    ...
    def __init__(self,
                 ...
                 mask_zero_radiance: bool = True,
                 precipitation_unit: Literal["mm", "cm"] = "cm",
    ...
    def download(self):
        name = self.required_file_names['data']
        download_url(self.url, self.root_dir, name)
        pass
    ...
    def build(self):
        ...
        from layers.tsl.ops.similarities import geographical_distance
