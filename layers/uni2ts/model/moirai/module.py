...
from layers.uni2ts.module.norm import RMSNorm
from layers.uni2ts.module.packed_scaler import PackedNOPScaler, PackedStdScaler
from layers.uni2ts.module.position import (
    BinaryAttentionBias,
    QueryKeyProjection,
    RotaryProjection,
)
from layers.uni2ts.module.transformer import TransformerEncoder
from layers.uni2ts.module.ts_embed import MultiInSizeLinear
...
class MoiraiModule(
    ...
    def forward(
        ...
        # print(f"{observed_mask.shape=}")
        # print(f"{sample_id.shape=}")
        # print(f"{time_id.shape=}")
        # print(f"{variate_id.shape=}")
        # print(f"{prediction_mask.shape=}")
        # print(f"{patch_size.shape=}")
