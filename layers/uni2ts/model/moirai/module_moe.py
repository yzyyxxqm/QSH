...
from layers.uni2ts.common.torch_util import packed_causal_attention_mask
...
from layers.uni2ts.module.ts_embed import FeatLinear, MultiInSizeLinear
...
class MoiraiMoEModule(
    ...
    # coders={DistributionOutput: (encode_distr_output)},
):
    """
