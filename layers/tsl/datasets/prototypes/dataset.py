...
from layers.tsl import config, logger
...
class Dataset(object):
    """Base class for Datasets in layers.tsl.
    ...
    def get_connectivity(self,
        ...
        if 'sparse' in kwargs:
            ...
            warnings.warn("The argument 'sparse' is deprecated and will be "
                          "removed in future version of layers.tsl. Please use "
        ...
        if knn is not None:
            from layers.tsl.ops.similarities import top_k
            adj = top_k(adj,
                        knn,
        ...
        if layout == 'dense':
            ...
            from layers.tsl.ops.connectivity import adj_to_edge_index
